...
<div class="hero">
  ...
  <h2>Create fast, beautiful data apps, dashboards, and reports from the command line. Write Markdown, JavaScript, React, SQL, Python, R… and any language you like. Free and open-source.</h2>
  <div class="cta">
